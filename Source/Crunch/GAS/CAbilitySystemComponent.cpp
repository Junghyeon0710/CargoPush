...
void UCAbilitySystemComponent::GiveInitialAbilities()
{
	...
	for (const TPair<ECAbilityInputID, TSubclassOf<UGameplayAbility>>& AbilityPair : BaseAbilities)
	{
...
void UCAbilitySystemComponent::Server_UpgradeAbilityWithID_Implementation(ECAbilityInputID InInputID)
{
	bool bFound =false;
	...
	FGameplayAbilitySpec* AbilitySpec = FindAbilitySpecFromInputID((int32)InInputID);
...
bool UCAbilitySystemComponent::Server_UpgradeAbilityWithID_Validate(ECAbilityInputID InInputID)
{
	return true;
}
